...
<div className="mt-4 text-sm  h-36 border overflow-y-scroll">
  {medications.map(med => (
    ...
    >
      ...
      {/* Graph */}
      <div className="mt-8">
      <MemoizedMedicationGraph medication={selectedMedication} medicationStuff={selectedMedication && selectedMedication.nm} odsCode={odsCode} odsName={odsName} mode={mode} />
